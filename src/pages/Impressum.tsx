        ...
        <div className="bg-white/10 border border-white/20 rounded-2xl p-8 md:p-12 backdrop-blur-sm">
          ...
          <div className="space-y-6 text-gray-300">
            <div>
              ...
              <p className="text-lg">
                <strong className="text-white">DJ Gery White</strong>
              </p>
              <p>Gery White</p>
              <p>Musterstr.</p>
              <p>12345</p>
            ...
            <div>
              ...
              <p>Mobil: <a href="tel:+491602763524" className="hover:opacity-80 transition-colors" style={{ color: '#FF6C01' }}>+49 160 2763524</a></p>
              <p>E-Mail: <a href="mailto:booking@djgerywhite.com" className="hover:opacity-80 transition-colors" style={{ color: '#FF6C01' }}>booking@djgerywhite.com</a></p>
              <p>Website: <a href="https://www.djgerywhite.com" className="hover:opacity-80 transition-colors" style={{ color: '#FF6C01' }}>www.djgerywhite.com</a></p>
            </div>
